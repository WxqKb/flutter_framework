...
class _LoginView extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: ModalProgressHUD(child:MediaQuery.removePadding(
          context: context,
          removeTop: true,
          child: new SafeArea(
                              ...
                              new Positioned(
                                ...
                                child: new Row(
                                  children: <Widget>[
                                    ...
                                    new Text(
                                      '记住密码',style: new TextStyle(color:loginVM.radioValue?const Color(0xff00b4ed):Colors.black,fontSize: ScreenUtil().setSp(24)),
                                    )
                                  ],
                                ))
                            ],
